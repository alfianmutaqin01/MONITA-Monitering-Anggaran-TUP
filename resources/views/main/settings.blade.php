...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if($pendingData)
                        <p class="mb-3">Tahun <strong>{{ $pendingData['year'] }}</strong> sudah memiliki data spreadsheet tersimpan.</p>
    ...
    >
        <i class="bi bi-clipboard"></i>
            ...
            <form action="{{ route('settings.update') }}" method="POST" id="form-spreadsheet" class="mb-5 p-3 border rounded-3 bg-light">
                @csrf
                <div class="row align-items-end">
                    <div class="col-md-2">
                        <label class="form-label">Tahun Anggaran</label>
                        <input type="number" name="year" id="input-year" class="form-control" 
                    ...
                    <tbody>
                        @forelse ($sheetYears as $year => $id)
                            <tr class="{{ $activeYear == $year ? 'table-primary fw-bold' : '' }}" data-year="{{ $year }}">
                                ...
                                <td>
                                    <a href="https://docs.google.com/spreadsheets/d/{{ $id }}" target="_blank" class="btn btn-sm btn-outline-secondary">
                    ...
                    <div class="col-md-6 border-end pe-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="jabatan_1" class="form-control" 
                                   value="{{ $ttdData['ttd_jabatan_1'] ?? '' }}" 
                                   placeholder="Contoh: Kepala Bagian">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nama Lengkap TTD 1</label>
                            <input type="text" id="nama_1" class="form-control" 
                                   value="{{ $ttdData['ttd_nama_1'] ?? '' }}" 
                                   placeholder="Nama lengkap penanda tangan">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">NIP TTD 1</label>
                            <input type="text" id="nip_1" class="form-control" 
                                   value="{{ $ttdData['ttd_nip_1'] ?? '' }}" 
                    ...
                    <div class="col-md-6 ps-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="jabatan_2" class="form-control" 
                                   value="{{ $ttdData['ttd_jabatan_2'] ?? '' }}" 
                                   placeholder="Contoh: Bendahara Pengeluaran">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nama Lengkap TTD 2</label>
                            <input type="text" id="nama_2" class="form-control" 
                                   value="{{ $ttdData['ttd_nama_2'] ?? '' }}" 
                                   placeholder="Nama lengkap penanda tangan">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">NIP TTD 2</label>
                            <input type="text" id="nip_2" class="form-control" 
                                   value="{{ $ttdData['ttd_nip_2'] ?? '' }}" 
                                   placeholder="Nomor Induk Pegawai">
                        </div>
                    </div>
                </div>
